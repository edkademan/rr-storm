...
This report summarizes the economic and human consequences of storms
...
very insignificant ways. For example, `WINDS` and `HIGH WINDS`.
...
Instead of just summarizing all the data by event it is useful
to look at what the data have to tell us by decade. Keep in mind
however that we only have 2 years for the very last decade---2010
and 2011.
